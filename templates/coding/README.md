...
|--------|-------------|-------------|
| `Project/` | Auto-allowed (exempt tools) | Working directory for all project files |
...
Exempt tools targeting `Project/` proceed without a dialog.

### Tier 2 — Force Ask

Exempt tools outside `Project/`, or any non-exempt tool anywhere, trigger a VS Code approval dialog.
...
These tools are auto-allowed inside `Project/` and trigger an approval dialog elsewhere:
