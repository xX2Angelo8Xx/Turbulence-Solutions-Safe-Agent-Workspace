...
def test_setup_iss_version_is_1_0_0():
    ...
    assert 'MyAppVersion "2.0.0"' in content, (
        "setup.iss MyAppVersion must be 2.0.0 to match pyproject.toml. Got something else."
    )
...
def test_build_dmg_version_is_1_0_0():
    ...
    assert 'APP_VERSION="2.0.0"' in content, (
        "build_dmg.sh APP_VERSION must be 2.0.0 to match pyproject.toml. Got something else."
    )
...
def test_build_appimage_version_is_1_0_0():
    ...
    assert 'APP_VERSION="2.0.0"' in content, (
        "build_appimage.sh APP_VERSION must be 2.0.0 to match pyproject.toml. Got something else."
    )
