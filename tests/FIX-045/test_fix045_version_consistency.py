"""
FIX-045 — Version Consistency Tests
Verifies that the version string "2.1.3" is correctly set in all 5 canonical
locations and that all locations are in sync.
"""
import re
...
def test_config_py_version() -> None:
    """config.py VERSION constant must be 2.1.3."""
...
def test_pyproject_toml_version() -> None:
    """pyproject.toml [project] version must be 2.1.3."""
...
def test_setup_iss_version() -> None:
    """setup.iss MyAppVersion must be 2.1.3."""
...
def test_build_dmg_version() -> None:
    """build_dmg.sh APP_VERSION must be 2.1.3."""
...
def test_build_appimage_version() -> None:
    """build_appimage.sh APP_VERSION must be 2.1.3."""
...
def test_all_versions_identical() -> None:
    """All 5 version locations must contain the identical string 2.1.3."""
