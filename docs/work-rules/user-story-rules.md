...
- User stories are tracked in `docs/user-stories/user-stories.jsonl`.
...
2. Workpackages reference their parent user story in the `User Story` field of `docs/workpackages/workpackages.jsonl`.
